...
- Instead of waiting for each operation to resolve before moving on to the next one, we can run them in parallel with methods like `Promise.all`
- This method accepts something that can be iterated over as an argument (usually an array)
